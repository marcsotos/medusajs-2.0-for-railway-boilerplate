    ...
    <div className="sticky top-0 inset-x-0 z-50">
      ...
      <header className="bg-white border-b border-gray-200 shadow-sm">
        <nav className="content-container flex items-center justify-between w-full h-16">
          ...
          {/* Barra de Búsqueda Principal - Centro */}
            ...
            >
              <div className="relative w-full group">
                <input
                  ...
                  className="w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent text-sm bg-white shadow-sm hover:shadow-md transition-shadow duration-200"
                  readOnly
                />
                <div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center gap-2">
                  <svg
                    className="w-5 h-5 text-gray-400 group-hover:text-slate-600 transition-colors duration-200"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          <div className="flex items-center gap-4 flex-1 basis-0 justify-end">
            {/* Búsqueda Mobile */}
            <LocalizedClientLink
              className="md:hidden flex items-center gap-2 px-3 py-2 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors duration-200 border border-gray-200"
              href="/search"
              scroll={false}
